...
- **pOpen-deGFP:** The pOpen-deGFP construct was designed to carry out deGFP expression via the T7 transcription system in Nucleus Cytosol {ref}`seq-degfp`. The plasmid sequence is attached to this DevNote (kept in-devnote to back the interactive plasmid viewer below); canonical copy: [nucleus-eng/DNA/reporters/pOpen-deGFP.gbk](https://github.com/nucleus-eng/DNA/blob/f7654f79d032efe157940e9ae388f5d405dcb29c/reporters/pOpen-deGFP.gbk).
