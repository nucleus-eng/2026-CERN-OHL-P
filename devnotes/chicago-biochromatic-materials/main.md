...
:::{figure} chicago-plan-schematic.png
Modules and integration diagram for the proposed demonstration.
:::

# Component Modules

- **Module 1-1**: Plans for in vitro validation of the sensors going into the Chicago node demonstration. [[link](https://devnotes.nucleus.engineering/articles/bnext-devnotes-chicago-m1-1-1)]
- **Module 1-2**: Environmentally Responsive Materials via Integration of DevCells. [[link](https://devnotes.nucleus.engineering/articles/bnext-devnotes-chicago-m1-2-1)]
- **Module 1-3**: Matrix Design for Stable Liposomes and Efficient Cell-Free Protein Synthesis. [[link](https://devnotes.nucleus.engineering/articles/bnext-devnotes-chicago-m1-3-1)]
- **Module 1-4**: In Vitro Reporter Validation. [[link](https://devnotes.nucleus.engineering/articles/bnext-devnotes-chicago-m1-4-1)]
- **Module 1-5**: Module Development Plan: pH sensor. [[link](https://devnotes.nucleus.engineering/articles/bnext-devnotes-chicago-m1-5-1)]
- **Module 2**: Colorimetric Sensing Module Development Plan. [[link](https://devnotes.nucleus.engineering/articles/bnext-devnotes-chicago-m2-1)]
- **Module 3**: Photopatterned Hydrogels with DevCells. [[link](https://devnotes.nucleus.engineering/articles/bnext-devnotes-chicago-m3-1)]
