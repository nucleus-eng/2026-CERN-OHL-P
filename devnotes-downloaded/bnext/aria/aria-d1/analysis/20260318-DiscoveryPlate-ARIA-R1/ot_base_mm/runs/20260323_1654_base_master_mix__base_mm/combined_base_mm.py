...
SAMPLES_TITRATION_LABCRAFT = [
    {'Well': 'I13', '[Magnesium acetate] (mM)': 7.6, '[Creatine phosphate] (mM)': 21.8, '[Potassium glutamate] (mM)': 98.4, '[ATP] (mM)': 1.947, '[GTP] (mM)': 2.263, '[Amino Acids] (mM)': 0.447, '[tRNA] (ug/uL)': 3.14},
    {'Well': 'F12', '[Magnesium acetate] (mM)': 1.0, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 40.0, '[ATP] (mM)': 3.042, '[GTP] (mM)': 1.403, '[Amino Acids] (mM)': 0.289, '[tRNA] (ug/uL)': 2.338},
    {'Well': 'F11', '[Magnesium acetate] (mM)': 6.7, '[Creatine phosphate] (mM)': 44.7, '[Potassium glutamate] (mM)': 76.9, '[ATP] (mM)': 2.876, '[GTP] (mM)': 2.036, '[Amino Acids] (mM)': 0.299, '[tRNA] (ug/uL)': 1.84},
    {'Well': 'H10', '[Magnesium acetate] (mM)': 7.7, '[Creatine phosphate] (mM)': 98.3, '[Potassium glutamate] (mM)': 41.5, '[ATP] (mM)': 2.633, '[GTP] (mM)': 2.516, '[Amino Acids] (mM)': 0.458, '[tRNA] (ug/uL)': 2.426},
    {'Well': 'F10', '[Magnesium acetate] (mM)': 1.0, '[Creatine phosphate] (mM)': 43.8, '[Potassium glutamate] (mM)': 40.0, '[ATP] (mM)': 2.399, '[GTP] (mM)': 2.721, '[Amino Acids] (mM)': 0.26, '[tRNA] (ug/uL)': 2.623},
    {'Well': 'H15', '[Magnesium acetate] (mM)': 8.4, '[Creatine phosphate] (mM)': 13.4, '[Potassium glutamate] (mM)': 102.7, '[ATP] (mM)': 2.841, '[GTP] (mM)': 2.126, '[Amino Acids] (mM)': 0.388, '[tRNA] (ug/uL)': 4.0},
    {'Well': 'I15', '[Magnesium acetate] (mM)': 24.3, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 86.2, '[ATP] (mM)': 3.705, '[GTP] (mM)': 2.861, '[Amino Acids] (mM)': 0.276, '[tRNA] (ug/uL)': 2.237},
    {'Well': 'G10', '[Magnesium acetate] (mM)': 6.5, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 56.0, '[ATP] (mM)': 2.612, '[GTP] (mM)': 2.991, '[Amino Acids] (mM)': 0.26, '[tRNA] (ug/uL)': 4.0},
    {'Well': 'I14', '[Magnesium acetate] (mM)': 6.4, '[Creatine phosphate] (mM)': 7.9, '[Potassium glutamate] (mM)': 95.8, '[ATP] (mM)': 2.42, '[GTP] (mM)': 2.685, '[Amino Acids] (mM)': 0.227, '[tRNA] (ug/uL)': 3.783},
    {'Well': 'F9', '[Magnesium acetate] (mM)': 14.8, '[Creatine phosphate] (mM)': 52.9, '[Potassium glutamate] (mM)': 99.8, '[ATP] (mM)': 3.525, '[GTP] (mM)': 2.738, '[Amino Acids] (mM)': 0.382, '[tRNA] (ug/uL)': 2.81},
    {'Well': 'G12', '[Magnesium acetate] (mM)': 7.7, '[Creatine phosphate] (mM)': 21.5, '[Potassium glutamate] (mM)': 97.5, '[ATP] (mM)': 1.672, '[GTP] (mM)': 2.919, '[Amino Acids] (mM)': 0.388, '[tRNA] (ug/uL)': 3.546},
    {'Well': 'G15', '[Magnesium acetate] (mM)': 25.0, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 97.7, '[ATP] (mM)': 2.266, '[GTP] (mM)': 2.092, '[Amino Acids] (mM)': 0.361, '[tRNA] (ug/uL)': 3.502},
    {'Well': 'H13', '[Magnesium acetate] (mM)': 21.7, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 43.1, '[ATP] (mM)': 2.231, '[GTP] (mM)': 2.329, '[Amino Acids] (mM)': 0.422, '[tRNA] (ug/uL)': 3.179},
    {'Well': 'F15', '[Magnesium acetate] (mM)': 25.0, '[Creatine phosphate] (mM)': 91.7, '[Potassium glutamate] (mM)': 178.9, '[ATP] (mM)': 2.664, '[GTP] (mM)': 2.557, '[Amino Acids] (mM)': 0.473, '[tRNA] (ug/uL)': 1.978},
    {'Well': 'J13', '[Magnesium acetate] (mM)': 21.5, '[Creatine phosphate] (mM)': 0.0, '[Potassium glutamate] (mM)': 179.5, '[ATP] (mM)': 2.472, '[GTP] (mM)': 2.612, '[Amino Acids] (mM)': 0.191, '[tRNA] (ug/uL)': 2.88},
    {'Well': 'H14', '[Magnesium acetate] (mM)': 7.9, '[Creatine phosphate] (mM)': 19.5, '[Potassium glutamate] (mM)': 99.9, '[ATP] (mM)': 1.929, '[GTP] (mM)': 1.952, '[Amino Acids] (mM)': 0.352, '[tRNA] (ug/uL)': 1.355},
    {'Well': 'J14', '[Magnesium acetate] (mM)': 7.7, '[Creatine phosphate] (mM)': 32.9, '[Potassium glutamate] (mM)': 113.1, '[ATP] (mM)': 2.187, '[GTP] (mM)': 1.506, '[Amino Acids] (mM)': 0.444, '[tRNA] (ug/uL)': 3.375},
    {'Well': 'G11', '[Magnesium acetate] (mM)': 4.3, '[Creatine phosphate] (mM)': 23.7, '[Potassium glutamate] (mM)': 82.7, '[ATP] (mM)': 1.928, '[GTP] (mM)': 2.35, '[Amino Acids] (mM)': 0.304, '[tRNA] (ug/uL)': 3.953},
    {'Well': 'F13', '[Magnesium acetate] (mM)': 22.3, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 67.9, '[ATP] (mM)': 3.618, '[GTP] (mM)': 1.992, '[Amino Acids] (mM)': 0.253, '[tRNA] (ug/uL)': 3.338},
    {'Well': 'G9', '[Magnesium acetate] (mM)': 23.1, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 78.0, '[ATP] (mM)': 3.226, '[GTP] (mM)': 2.293, '[Amino Acids] (mM)': 0.149, '[tRNA] (ug/uL)': 3.834},
    {'Well': 'I9', '[Magnesium acetate] (mM)': 24.8, '[Creatine phosphate] (mM)': 99.8, '[Potassium glutamate] (mM)': 40.0, '[ATP] (mM)': 2.151, '[GTP] (mM)': 2.729, '[Amino Acids] (mM)': 0.434, '[tRNA] (ug/uL)': 2.74},
    {'Well': 'J9', '[Magnesium acetate] (mM)': 6.8, '[Creatine phosphate] (mM)': 0.0, '[Potassium glutamate] (mM)': 124.8, '[ATP] (mM)': 3.475, '[GTP] (mM)': 2.056, '[Amino Acids] (mM)': 0.339, '[tRNA] (ug/uL)': 2.953},
    {'Well': 'J11', '[Magnesium acetate] (mM)': 1.9, '[Creatine phosphate] (mM)': 41.7, '[Potassium glutamate] (mM)': 78.2, '[ATP] (mM)': 2.875, '[GTP] (mM)': 1.661, '[Amino Acids] (mM)': 0.359, '[tRNA] (ug/uL)': 2.329},
    {'Well': 'I11', '[Magnesium acetate] (mM)': 2.4, '[Creatine phosphate] (mM)': 3.2, '[Potassium glutamate] (mM)': 75.5, '[ATP] (mM)': 2.843, '[GTP] (mM)': 1.702, '[Amino Acids] (mM)': 0.347, '[tRNA] (ug/uL)': 2.543},
    {'Well': 'J10', '[Magnesium acetate] (mM)': 4.3, '[Creatine phosphate] (mM)': 0.0, '[Potassium glutamate] (mM)': 111.9, '[ATP] (mM)': 2.142, '[GTP] (mM)': 2.18, '[Amino Acids] (mM)': 0.346, '[tRNA] (ug/uL)': 3.281},
    {'Well': 'H11', '[Magnesium acetate] (mM)': 7.9, '[Creatine phosphate] (mM)': 19.5, '[Potassium glutamate] (mM)': 99.9, '[ATP] (mM)': 3.027, '[GTP] (mM)': 1.893, '[Amino Acids] (mM)': 0.304, '[tRNA] (ug/uL)': 2.504},
    {'Well': 'F14', '[Magnesium acetate] (mM)': 9.9, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 40.0, '[ATP] (mM)': 2.562, '[GTP] (mM)': 2.603, '[Amino Acids] (mM)': 0.321, '[tRNA] (ug/uL)': 4.0},
    {'Well': 'G14', '[Magnesium acetate] (mM)': 6.3, '[Creatine phosphate] (mM)': 30.1, '[Potassium glutamate] (mM)': 65.9, '[ATP] (mM)': 1.924, '[GTP] (mM)': 1.946, '[Amino Acids] (mM)': 0.402, '[tRNA] (ug/uL)': 2.126},
    {'Well': 'I10', '[Magnesium acetate] (mM)': 3.7, '[Creatine phosphate] (mM)': 0.0, '[Potassium glutamate] (mM)': 56.3, '[ATP] (mM)': 2.596, '[GTP] (mM)': 1.775, '[Amino Acids] (mM)': 0.523, '[tRNA] (ug/uL)': 2.124},
    {'Well': 'H12', '[Magnesium acetate] (mM)': 21.0, '[Creatine phosphate] (mM)': 33.9, '[Potassium glutamate] (mM)': 97.3, '[ATP] (mM)': 2.853, '[GTP] (mM)': 1.877, '[Amino Acids] (mM)': 0.31, '[tRNA] (ug/uL)': 2.922},
    {'Well': 'G13', '[Magnesium acetate] (mM)': 4.6, '[Creatine phosphate] (mM)': 30.9, '[Potassium glutamate] (mM)': 40.0, '[ATP] (mM)': 2.738, '[GTP] (mM)': 3.339, '[Amino Acids] (mM)': 0.286, '[tRNA] (ug/uL)': 3.892},
    {'Well': 'H9', '[Magnesium acetate] (mM)': 9.1, '[Creatine phosphate] (mM)': 0.0, '[Potassium glutamate] (mM)': 159.2, '[ATP] (mM)': 2.423, '[GTP] (mM)': 2.225, '[Amino Acids] (mM)': 0.312, '[tRNA] (ug/uL)': 1.927},
    {'Well': 'J12', '[Magnesium acetate] (mM)': 11.7, '[Creatine phosphate] (mM)': 4.1, '[Potassium glutamate] (mM)': 112.2, '[ATP] (mM)': 2.667, '[GTP] (mM)': 1.852, '[Amino Acids] (mM)': 0.307, '[tRNA] (ug/uL)': 1.86},
    {'Well': 'I12', '[Magnesium acetate] (mM)': 7.5, '[Creatine phosphate] (mM)': 0.0, '[Potassium glutamate] (mM)': 108.5, '[ATP] (mM)': 2.65, '[GTP] (mM)': 2.521, '[Amino Acids] (mM)': 0.43, '[tRNA] (ug/uL)': 3.25},
    {'Well': 'J15', '[Magnesium acetate] (mM)': 11.9, '[Creatine phosphate] (mM)': 100.0, '[Potassium glutamate] (mM)': 40.0, '[ATP] (mM)': 2.028, '[GTP] (mM)': 3.126, '[Amino Acids] (mM)': 0.455, '[tRNA] (ug/uL)': 3.225},
]
